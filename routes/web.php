...
Route::middleware(['authylp', 'can:access-admin-ylp'])->group(function () {
    Route::get('/ylp/admin', [DashboardController::class, 'index'])->name('dashboard');
...
Route::group(['middleware' => ['XSS']], function () {
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        Route::post('ficheSuiviPostFormation', [FormationController::class, 'ficheSuiviPostFormation'])->name('ficheSuiviPostFormation');
        ...
        Route::post('/formation/{idformation}/formationemargementcollective', [EmargementcollectiveController::class, 'giveformationemargementcollective'])->name('formationemargementcollective');
        ...
        /* Route::get('ajouterDemandeursPresenceJour/{idformation}/{idmodule}/{idlocalite}/{idemargement}', [FormationController::class, 'addajouterDemandeursPresenceJour'])->name('ajout.presence.get');
        Route::put('ajouterDemandeursPresenceJour/{idformation}/{idmodule}/{idlocalite}/{idemargement}', [FormationController::class, 'giveajouterDemandeursPresenceJour']); */

        Route::get(
            'ajouterDemandeursPresenceJour/{idformation}/{idmodule}/{idlocalite}/{idemargement}',
            [FormationController::class, 'addajouterDemandeursPresenceJour']
        )->name('ajout.presence.get');

        Route::put(
            'ajouterDemandeursPresenceJour/{idformation}/{idmodule}/{idlocalite}/{idemargement}',
            [FormationController::class, 'giveajouterDemandeursPresenceJour']
        );
        ...
        Route::get('collective/{id}/liste', [CollectiveController::class, 'liste'])->name('collective.liste');
        ...
        Route::get(
            '/individuelles/suivi/formulaire/{id}',
            [IndividuelleController::class, 'formulaire']
        )->name('individuelles.suivi.formulaire');

        Route::get(
            '/individuelles/suivi/modules',
            [IndividuelleController::class, 'modulesFormes']
        )->name('individuelles.suivi.modules');
        ...
        Route::put('/validationAgrement/{id}', [OperateurController::class, 'validationAgrement'])->name('validationAgrement');
        Route::put('/validationFormateur/{id}', [OperateurformateurController::class, 'validationFormateur'])->name('validationFormateur');
        Route::put('/validationEquipement/{id}', [OperateurequipementController::class, 'validationEquipement'])->name('validationEquipement');
        ...
        Route::get('collectives/index', [CollectiveController::class, 'index'])->name('collectives.report');
        Route::post('collectives/index', [CollectiveController::class, 'generateReport']);
        ...
        Route::get('showAttestations', [FormationController::class, 'showAttestations'])->name('showAttestations');
        ...
        Route::get(
            '/generer-contrat-lettre/{statut}',
            [FormulaireController::class, 'exportercontratlettrePDF']
        )
            ->name('generer-contrat-lettre.pdf');

        Route::get(
            '/generer-lalettre/{id}',
            [FormulaireController::class, 'exporterlalettrePDF']
        )
            ->name('generer-lalettre.pdf');

        Route::get(
            '/generer-lecontrat/{id}',
            [FormulaireController::class, 'exporterlecontratPDF']
        )
            ->name('generer-lecontrat.pdf');
        ...
        Route::get(
            '/prisenchargeExcel/export-excel/{statut}',
        ...
        Route::get(
            '/individuelles/{annee}/{region}/export-excel/{statut?}',
            [IndividuelleController::class, 'exportExcel']
        )->name('individuelles.exportExcel');
        ...
        Route::get('/attestations/annee/{annee}', [FormationController::class, 'attestationsParAnnee'])
            ->name('attestations.attestationsParAnnee');

        Route::get('/individuelles/{annee}/region/{region}', [IndividuelleController::class, 'parAnneeRegion'])
            ->name('individuelles.parAnneeRegion');

        Route::get('/formations/{annee}/region/{region}', [FormationController::class, 'parAnneeRegion'])
            ->name('formations.parAnneeRegion');

        Route::get('/attestations/{annee}/region/{region}', [FormationController::class, 'attestationsParAnneeRegion'])
            ->name('attestations.attestationsParAnneeRegion');
        ...
        Route::get('/operateurs/annee/{annee}/statut/{statut}/{region?}', [OperateurController::class, 'parAnneeEtStatut'])
        ...
        Route::get('/operateurs/statut/{calid}', [OperateurController::class, 'filtrerOperateurParCAL'])
            ->name('operateurs.filtrerOperateurParCAL');

        Route::get('/operateurs/statut/{calid}/{region}', [OperateurController::class, 'filtrerOperateurParCALRegion'])
            ->name('operateurs.filtrerOperateurParCALRegion');
        ...
        Route::get('/attestations/{formation}/telecharger', [AttestationController::class, 'attestations'])
            ->name('attestations.telecharger');
        ...
        Route::get(
            ...
            ->name('formations.attestations.lancer');

        Route::get(
            'formations/{formationId}/attestations/telecharger',
            [AttestationController::class, 'telechargerAttestationsGenerees']
        )
            ->name('formations.attestations.telecharger');
        ...
        Route::post('/operateur/{uuid}/certifier', [OperateurController::class, 'certifierOperateur'])
            ->name('certifierOperateur');

        Route::post('/operateurs/{uuid}/certification', [OperateurController::class, 'certificationOperateur'])
            ->name('certificationOperateur');

        Route::get('/export-ficheSynthese-all/{commissionagrement}', [OperateurController::class, 'exportficheSyntheseAll'])
            ->name('export.ficheSynthese.all');

        Route::get('/export-ficheSynthese-all-region/{commissionagrement}/{region}', [OperateurController::class, 'exportficheSyntheseAllRegion'])
            ->name('export.ficheSynthese.allregion');

        Route::get('/export-ficheSynthese/{commissionagrement}', [OperateurController::class, 'exportficheSynthese'])
            ->name('export.ficheSynthese');

        Route::get('/export-ficheSynthese-region/{commissionagrement}/{region}', [OperateurController::class, 'exportficheSyntheseRegion'])
            ->name('export.ficheSynthese.region');

        Route::get('/export-operateurs/{commissionagrement}', [OperateurController::class, 'exportAvecScans'])
            ->name('export.operateurs');
        ...
        Route::post(
            '/validation-operateur/{id}/update-validation',
            [ValidationoperateurController::class, 'updateValidation']
        )->name('validation-operateur.updateValidation');
        Route::resource('/collectives', CollectiveController::class);
    ...
    Route::get('/programme2025-2', function () {
        $path = public_path('programme2025-2.pdf');
