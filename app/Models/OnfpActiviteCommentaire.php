...
class OnfpActiviteCommentaire extends Model
{
    ...
    {
        return $this->belongsTo(OnfpTache::class, 'tache_id');
    }
    ...
    public function scopeSurActivite($query)
    {
        return $query->whereNull('tache_id');
    }

    public function scopeSurTache($query, int $tacheId)
    {
