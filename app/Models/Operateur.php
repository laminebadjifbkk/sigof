...
class Operateur extends Model
{
    ...
    public function commissionagrements()
    {
        /* return $this->belongsToMany(
            ...
            'operateur_id',                  // clé étrangère dans la table pivot pointant vers ce modèle
            'commissionagrement_id'          // clé étrangère dans la table pivot pointant vers le modèle cible
        ); */
