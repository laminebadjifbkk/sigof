...
class EmargementController extends Controller
{
    ...
    public function giveformationemargements(Request $request, $idformation)
    {
        $request->validate([
        ...
        if ($formation->statut == "Terminée") {
            ...
            foreach ($request->individuelles as $individuelle_id) {
                $individuelle = Individuelle::findOrFail($individuelle_id);
                $individuelle->update([
