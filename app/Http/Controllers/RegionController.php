...
class RegionController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware(['role:super-admin|admin|Employe|AntKD|AntKL|AntSL|AntKG|AntMT|AntDL|AntZG|AntTH|CAR|DG']);
    ...
    public function demandeur($id)
    {
        ...
        $individuelles = Individuelle::select('regions_id')->where('regions_id', $region->id)
            ->count();
