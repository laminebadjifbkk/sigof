                                                    ...
                                                    @can('devenir-operateur-agrement-ouvert')
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                                                                ...
                                                                <li>
                                                                    <form action="{{ route('operateurformateurs.destroy', $operateurformateur->id) }}"
                                                                        method="POST"
            ...
            <div class="modal-content shadow-lg border-0 rounded-4 overflow-hidden">
                <form method="POST" action="{{ route('operateurformateurs.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body px-4 py-4">
                        <div class="row g-3">
                            <div class="col-12">
                                <label class="form-label fw-semibold">Prénom(s) et Nom <span class="text-danger">*</span></label>
                            ...
                            <div class="col-12">
                                <label class="form-label fw-semibold">Domaine d'expertise <span class="text-danger">*</span></label>
                            ...
                            <div class="col-12">
                                <label class="form-label fw-semibold">Années d'expérience <span class="text-danger">*</span></label>
                                <input type="number" name="nbre_annees_experience" value="{{ old('nbre_annees_experience') }}"
                                    min="0"
                                    class="form-control form-control-sm @error('nbre_annees_experience') is-invalid @enderror"
                                    placeholder="Ex : 7" required>
                                @error('nbre_annees_experience')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold">Référence professionnelle <span class="text-danger">*</span></label>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="domaine"
                                        ...
                                        class="form-control form-control-sm @error('domaine') is-invalid @enderror" required>
                                    @error('domaine')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-12">
                                    <label class="form-label fw-semibold">Années d'expérience <span class="text-danger">*</span></label>
                                    <input type="number" name="nbre_annees_experience" min="0"
                                        ...
                                        class="form-control form-control-sm @error('nbre_annees_experience') is-invalid @enderror" required>
                                    @error('nbre_annees_experience')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-12">
                                    <label class="form-label fw-semibold">Référence professionnelle <span class="text-danger">*</span></label>
                                    <input type="text" name="reference"
                                        ...
                                        class="form-control form-control-sm @error('reference') is-invalid @enderror" required>
                                    <small class="text-muted">Structure, projet, responsable ou mission</small>
                                    @error('reference')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-md-10">
