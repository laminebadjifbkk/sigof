...
@section('title', 'Modification formation ' . $formation?->code)
@section('space-work')
                                ...
                                <form method="post" action="{{ route('formations.update', $formation) }}"
                                    ...
                                    <div class="col-12 col-md-12 col-lg-12 col-sm-12 col-xs-12 col-xxl-12">
                                        ...
                                        <textarea name="intitule" id="intitule" rows="1"
                                            ...
                                            placeholder="ex : Technique de coupe-couture">{{ $formation?->intitule ?? old('intitule') }}</textarea>
                                        @error('intitule')
                                    ...
                                    <div class="col-12 col-md-12 col-lg-12 col-sm-12 col-xs-12 col-xxl-12">
                                        <label for="regions" class="form-label">
                                            Région(s) de provenance des bénéficiaires
                                    ...
                                    <div class="col-12 col-md-12 col-lg-4 col-sm-12 col-xs-12 col-xxl-4">
                                        <div class="mb-3">
                                            <label class="form-label">Autre date évaluation</label>
                                            <input type="date" name="date_pv_finale"
                                                value="{{ $formation?->date_pv_finale?->format('Y-m-d') ?? old('date_pv_finale') }}"
                                                class="datepicker form-control form-control-sm @error('date_pv_finale') is-invalid @enderror"
                                                id="date_pv_finale" placeholder="jj/mm/aaaa">
                                            @error('date_pv_finale')
                                                <span class="invalid-feedback" role="alert">
                                                    <div>{{ $message }}</div>
                                                </span>
                                            @enderror
                                    ...
                                    <div class="col-12 col-md-12 col-lg-12 col-sm-12 col-xs-12 col-xxl-12">
                                        <label for="onfpevaluateur" class="form-label">Evaluateur ONFP</label>
