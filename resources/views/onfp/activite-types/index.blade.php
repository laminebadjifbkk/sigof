...
@section('space-work')
    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('onfp.activite-types.create') }}" class="btn btn-sm btn-primary">
        ...
        <div class="card shadow-sm border-0 mb-4">
            ...
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('onfp.activite-types.index') }}">
                    ...
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="actif" class="form-select form-select-sm">
                                ...
                                <option value="1" {{ request('actif') === '1' ? 'selected' : '' }}>
                                    Actifs
                                </option>

                                <option value="0" {{ request('actif') === '0' ? 'selected' : '' }}>
                                    Inactifs
                                </option>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('onfp.activite-types.index') }}" class="btn btn-sm btn-outline-secondary">
