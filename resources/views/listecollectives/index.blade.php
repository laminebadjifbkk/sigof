                                ...
                                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <h6 class="mb-0 text-muted fw-semibold text-uppercase">
                                            Liste des demandeurs collectifs
                                        </h6>
                                    </div>

                                    {{-- Total au centre --}}
                                    @php
                                        $affichees = $listecollectives?->count(); // à adapter si tu fais une pagination
                                        $total =
                                            $totalListecollective ??
                                            ($listecollectives?->total() ?? $listecollectives?->count()); // en cas de pagination avec ->total()
                                    @endphp
                                    ...
                                    @can('individuelle-create')
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <button class="btn btn-sm btn-outline-secondary" type="button" data-bs-toggle="modal"
                                                data-bs-target="#searchCollective">
                                                Rechercher plus
                                            </button>
                                        </div>
                                    @endcan
