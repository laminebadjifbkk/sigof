...
@section('title', $projet?->sigle . ', liste des demandes ' . $statut, ' région de ' . $region, ' en ' . $module)
@section('space-work')
    <div class="pagetitle">
        {{-- <h1>Data Tables</h1> --}}
        <nav>
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="card-title">
                            <div
                                ...
                                <span>{{ $projet->sigle . ' | ' . $module . ' | ' . $region }}</span>
                                            ...
                                            @if ($statut == 'Conforme')
                                                {{-- <div class="filter">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                        <form action="{{ route('listeSelectionnesregion') }}" method="post"
                                                            target="_blank">
                                                            @csrf
