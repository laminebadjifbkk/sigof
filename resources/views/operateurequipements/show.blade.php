                                                            ...
                                                            {{-- @if (auth()->user()->hasRole('super-admin|admin'))
                                                                <li>
                                                                    <button class="btn btn-sm mx-1" data-bs-toggle="modal"
                                                                        data-bs-target="#ValidationEquipementModal{{ $operateurequipement->id }}"><i
                    ...
                    <form method="POST" action="{{ route('operateurequipements.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" name="designation" value="{{ old('designation') }}"
                                    class="form-control form-control-sm @error('designation') is-invalid @enderror"
                                    placeholder="Ex. : Salles de cours ou Ordinateurs">
                                @error('designation')
            ...
            <div class="modal fade" id="ValidationEquipementModal{{ $operateurequipement->id }}" tabindex="-1"
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content shadow-lg rounded-3">
                        ...
                        <form method="POST" action="{{ route('validationEquipement', ['id' => $operateurequipement->id]) }}">
                            @csrf
                            @method('PUT')
