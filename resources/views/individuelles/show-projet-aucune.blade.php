                            ...
                            <form method="post" action="{{ route('profile.update', $user->uuid) }}"
                                ...
                                <div class="col-12 col-md-6 col-lg-4 mb-0">
                                    ...
                                    <input name="cin" type="text"
                                        ...
                                        placeholder="Ex: 1099200500012" minlength="9" maxlength="14" required>
                                    @error('cin')
                                        <span class="invalid-feedback" role="alert">
                                            <div>{{ $message }}</div>
                                        </span>
                                            ...
                                            <h1 class="h4 text-black mb-0">Formuler une demande de formation en
                                                ...
                                                <div class="modal-header bg-warning bg-gradient text-white py-4 px-4">
                                                    <div>
                                                        <h5 class="modal-title fw-bold mb-1">
                                                            Formuler une demande de formation pour le
                                                ...
                                                <div class="modal-body">
                                                    <div class="row g-3">
                                                        ...
                                                        <div
                                                            class="col-12 col-md-12 col-lg-6 col-sm-12 col-xs-12 col-xxl-4">
                                                            ...
                                                            <select name="departement"
                                                                id="module_select_{{ $projetmodule->id }}"
                                                        ...
                                                        <div
                                                            ...
                                                            <input name="telephone_secondaire" type="text"
                                                                maxlength="12"
                                                        ...
                                                        <div
                                                            ...
                                                            <select name="diplome_academique"
                                                                ...
                                                                aria-label="Select"
                                                                id="select-field-diplome_academique-ind"
                                                        ...
                                                        <div
                                                            class="col-12 col-md-12 col-lg-6 col-sm-12 col-xs-12 col-xxl-4">
                                                            <label for="autre_diplome_academique" class="form-label">Si
                                                                autre ?
                                                                précisez</label>
                                                        ...
                                                        <div
                                                            class="col-12 col-md-12 col-lg-6 col-sm-12 col-xs-12 col-xxl-4">
                                                            <label for="option_diplome_academique"
                                                                class="form-label">Option du
                                                                diplôme</label>
                                                        ...
                                                        <div
                                                            class="col-12 col-md-12 col-lg-6 col-sm-12 col-xs-12 col-xxl-4">
                                                            <label for="etablissement_academique"
                                                        ...
                                                        <div
                                                            class="col-12 col-md-12 col-lg-6 col-sm-12 col-xs-12 col-xxl-4">
                                                            <label for="autre_diplome_professionnel" class="form-label">Si
                                                                autre ?
                                                                précisez</label>
                                                        ...
                                                        <div class="col-12">
                                                            <label for="projet_poste_formation" class="form-label">Votre
                                                                projet
                                                                après
                                                                la
                                                            ...
                                                            <select name="projet_poste_formation"
                                                                ...
                                                                aria-label="Select"
                                                                id="select-field-projet_poste_formation-ind"
                                                        ...
                                                        <div class="col-12 mb-0">
                                                            <label for="qualification" class="form-label">Qualification et
                                                                autres
                                                                diplômes</label>
                                                        ...
                                                        <div class="col-12 mb-0">
                                                            <label for="projetprofessionnel"
                                                                class="form-label">Informations
                                                                complémentaires
                                                                sur
                                                                le projet
                                                                professionnel<span
