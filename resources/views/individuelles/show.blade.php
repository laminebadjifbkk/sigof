    ...
    <section class="section min-vh-0 d-flex flex-column align-items-center justify-content-center py-0 section profile">
        <div class="container-fluid">
            ...
            'Lieu de formation' => $individuelle?->departement?->nom,
                                    ...
                                    @if (!empty($individuelle?->note_obtenue))
                                        @php
                                            $rawNoteObtenue = floatval($individuelle?->note_obtenue); // valeur brute
                                            $noteClass = match (true) {
                                                $rawNoteObtenue < 12 => 'text-danger fw-bold', // Rouge pour < 12
                                                $rawNoteObtenue >= 12 => 'text-primary fw-bold', // Bleu pour >= 12
                                                default => 'text-warning fw-bold',
                                            };
                                            $formattedNoteObtenue =
                                                fmod($rawNoteObtenue, 1) == 0.0
                                                    ? number_format($rawNoteObtenue, 0, ',', ' ') // Pas de décimale si entier
                                                    : number_format($rawNoteObtenue, 1, ',', ' '); // Une décimale sinon
                                        @endphp
                                    ...
                                    @if ($individuelle?->appreciation)
                                        @php
                                            $appreciation = strtolower($individuelle?->appreciation);
                                            $noteClass = match ($appreciation) {
                                                'excellent' => 'text-success fw-bold',
                                                'très bien', 'tres bien' => 'text-primary fw-bold',
                                                'bien' => 'text-info fw-bold',
                                                'assez bien' => 'text-warning fw-bold',
                                                'passable' => 'text-secondary fw-bold',
                                                'insuffisant', 'échec', 'echec' => 'text-danger fw-bold',
                                                default => 'text-muted fw-bold',
                                            };
                                        @endphp
                                        <div class="col-12 col-md-4">
                                            <div class="label">Appréciation formation</div>
                                            <div>
                                                <span class="{{ $noteClass }}">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="card shadow-sm border-0 rounded-3">
                                            ...
                                            <div class="card-body">
                                                                    ...
                                                                    @hasanyrole('super-admin|admin|DIOF|ADIOF|Ingenieur')
                                                                        <div class="mt-1 d-flex gap-2 flex-wrap">
                                                                            ...
                                                                            <small class="text-muted">Modifié le
                                                                                {{ $file?->updated_at?->format('d/m/Y à H:i') }}</small>
                                                                        </div>
                                                                    @endhasanyrole
                                                                </div>
                                                ...
                                                @else
                                                    <div class="alert alert-info small">Aucun fichier disponible pour le
                                                        moment.</div>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="card shadow-sm border-0 rounded-3">
                                            <div class="card-header bg-light">
                                                <h5 class="mb-0 text-uppercase fw-bold">
                                                    <i class="bi bi-mortarboard me-2 text-success"></i> Formations
                                                </h5>
                                            </div>
                                            <div class="card-body">
                                                @if ($individuelle?->user?->formations->isNotEmpty())
                                                    <div class="list-group">
                                                        @foreach ($individuelle?->user?->formations as $formation)
                                                            <div
                                                                class="list-group-item d-flex justify-content-between align-items-center">
                                                                <div>
                                                ...
                                                @else
                                                    <div class="alert alert-info small">Aucune formation pour le moment.
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
