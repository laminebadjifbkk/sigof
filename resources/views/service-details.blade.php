...
<body class="service-details-page">
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="service-box">
                            ...
                            <div class="download-catalog">
                                <a href="{{ url('/programme2025-2.pdf') }}" target="_blank"><i
                                        class="bi bi-filetype-pdf"></i><span>Appel à candidature 2025 - Phase
                                        2</span></a>
                            </div>
                            <div class="download-catalog">
                                <a href="{{ url('/Note_d_information_CAL_2025.pdf') }}" target="_blank"><i
                                        class="bi bi-filetype-pdf"></i><span>Agrément opérateurs 2025</span></a>
                            </div>
                            {{-- <div class="download-catalog">
                                <a href="{{ url('/programme2025-1.pdf') }}" target="_blank"><i
                                        class="bi bi-filetype-pdf"></i><span>Appel à candidature 2025 - Phase
                                        1</span></a>
                            </div> --}}
                            <div class="download-catalog">
                                <a href="{{ url('/guide.pdf') }}" target="_blank"><i
                                        class="bi bi-filetype-pdf"></i><span>Guide utilisateur
                                        (PDF)</span></a>
                            </div>
                        </div>
    ...
    <footer id="footer" class="footer">
        ...
        <div class="container copyright text-center mt-4">
            <p>© <span>Copyright</span> <strong class="px-1 sitename">ONFP</strong> <span></span></p>
            <div class="credits">
