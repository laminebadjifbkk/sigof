    ...
    <section class="section register">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h3 class="mb-0">Modifier le véhicule</h3>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="assurance_expire_le" class="form-control form-control-sm"
                                    value="{{ old('assurance_expire_le', $vehicule->assurance_expire_le_formatted) }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="date" name="visite_technique_expire_le"
                                    ...
                                    value="{{ old('visite_technique_expire_le', $vehicule->visite_technique_expire_le_formatted) }}">
                            </div>
                            <div class="col-md-6">
