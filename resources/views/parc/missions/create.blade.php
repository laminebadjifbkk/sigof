                        ...
                        <div class="mb-3">
                            ...
                            <select name="statut" id="statut" class="form-select form-select-sm" required>
                                ...
                                <option value="en_cours"
                                    {{ old('statut', $mission->statut ?? '') == 'en_cours' ? 'selected' : '' }}>En cours
                                </option>
                                <option value="terminee"
                                    {{ old('statut', $mission->statut ?? '') == 'terminee' ? 'selected' : '' }}>Terminée
                                </option>
                                <option value="annulee"
                                    {{ old('statut', $mission->statut ?? '') == 'annulee' ? 'selected' : '' }}>Annulée
                                </option>
                            </select>
                            @error('statut')
