        ...
        <div class="container">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <small class="text-muted">
                                            Le {{ $mission->created_at?->translatedFormat('l jS F Y à H:i') }} 
            ...
            <div class="d-flex flex-wrap gap-2 mb-4">
                ...
                @can('parc-vehicule-update')
                    <a href="{{ route('parc-missions.vehicules.edit', $mission) }}" class="btn btn-secondary btn-sm">
                ...
                {{-- Ordres de mission --}}
                @can('parc-odre-mission-edit')
                    <a href="{{ route('parc-missions.pdf', $mission) }}" class="btn btn-success btn-sm" target="_blank">
                        <i class="bi bi-file-earmark-pdf"></i> Ordres de mission
                    </a>
                @endcan
