                    ...
                    <form action="{{ route('parc-missions.update', $mission) }}" method="POST">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <select name="statut" class="form-select form-select-sm">
                                    ...
                                    <option value="cloturee"
                                        {{ old('statut', $mission->statut) == 'cloturee' ? 'selected' : '' }}>
                                        Clôturée</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <input type="number" name="autres"
                                    ...
                                    value="{{ old('autres', $mission->autres ?? '1') }}" placeholder="Ex: 1" min="0"
                                    step="1">
                                @error('autres')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <input type="number" step="0.01" name="avance" class="form-control form-control-sm"
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <input type="number" name="distance_km" id="distance_km"
                                    ...
                                    min="0" value="{{ old('distance_km', $mission?->distance_km) }}"
