                            ...
                            <div class="card-body">
                                ...
                                {{-- @foreach ($formations as $formation)
                                    @php
                                        ...
                                        $progress = 0;
                                        $color = 'bg-danger'; // défaut à 0%

                                        if ($isIndividuelle) {
                                            $nb = $formation?->emargements?->count() ?? 0;
                                            $progress = round(($nb / $formation->duree_formation) * 100);
                                        } elseif ($isCollective) {
                                            $nb = $formation?->emargementcollectives?->count() ?? 0;
                                            $progress = round(($nb / $formation->duree_formation) * 100);
                                        }
                                    ...
                                    <div class="border rounded p-3 mb-4 shadow-sm bg-white">
                                        <h6 class="text-primary mb-3">
                                            ...
                                            Module :
                                            <a href="{{ route('formations.show', $formation) }}">
                                                {{ $isIndividuelle ? $formation?->module?->name : ($isCollective ? $formation?->collectivemodule?->module : 'Non défini') }}
                                            </a>
                                        </h6>
