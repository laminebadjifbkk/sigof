...
@section('title', 'Enregistrement décision')
@section('space-work')
...
@push('scripts')
    <script type="text/javascript">
        ...
        $("#add-btn").click(function() {
            ++i;
            $("#dynamicAddRemove").append('<tr><td><input type="text" name="decisions[' + i +
                '][name]" placeholder="Entrer une autre décision" class="form-control" /></td><td><button type="button" class="btn btn-danger remove-tr">Supprimer</button></td></tr>'
            );
        });
