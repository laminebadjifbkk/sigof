            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Création indemnite</h5>
                        <!-- indemnite -->
                        <form method="post" action="{{ url('indemnites') }}" enctype="multipart/form-data" class="row g-3">
                            @csrf
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dynamicAddRemove">
                                    ...
                                    <tr>
                                        <td><input type="text" name="indemnites[0][name]"
                                                placeholder="Entrer une indemnite" class="form-control form-control-sm"
                                                autofocus /></td>
