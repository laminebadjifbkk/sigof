...
@section('title', 'ajouter indemnite')
@section('space-work')
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- indemnite -->
                        <form method="post" action="{{ url('employes/' . $employe->id . '/give-indemnites') }}"
                            ...
                            <div class="row mb-3">
                                ...
                                @foreach ($indemnites as $indemnite)
                                    <div class="form-check col-12 col-md-12 col-lg-12">
                                        <label>
                                            <input type="checkbox" name="indemnites[]" value="{{ $indemnite->id }}"
                                                {{ in_array($indemnite->id, $employesIndemnites) ? 'checked' : '' }}
                                                class="form-check-input @error('indemnites') is-invalid @enderror">
                                            {{ $indemnite->name }}
                                            @error('indemnites')
