...
<div class="panel">
    ...
    <div class="detail-grid">
        ...
        <div class="detail-item">
            ...
            <span class="detail-value">{{ $candidature->langue_vivante_2 ? ucfirst($candidature->langue_vivante_2) : 'Aucune' }}</span>
        </div>
    </div>
</div>
...
<div class="panel">
    ...
    <div class="detail-grid">
        <div class="detail-item">
            ...
            <span class="detail-value">{{ $candidature->disponible_debut->format('d/m/Y') }} au {{ $candidature->disponible_fin->format('d/m/Y') }}</span>
        </div>
        <div class="detail-item">
