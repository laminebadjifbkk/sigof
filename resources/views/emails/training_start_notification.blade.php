...
<body>
    ...
    <p>
        ...
        <strong>Opérateur :</strong> {{ $individuelle?->formation?->operateur?->user?->display_operateur }}
        ({{ $individuelle?->formation?->operateur?->user?->display_operateur }}) <br>
        <strong>Adresse :</strong>
        @if ($individuelle?->formation?->operateur?->user?->adresse)
            {{ $individuelle?->formation?->lieu . ' - ' . $individuelle?->formation?->operateur?->user?->adresse }}
        @else
            Non disponible
        @endif
    </p>
