                    ...
                    <div class="card-body">
                        ...
                        <div class="pt-1">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
                                ...
                                {{-- Total au centre --}}
                                @php
                                    $affichees = $utilisateurs?->count(); // à adapter si tu fais une pagination
                                    $total = $totalUtilisateurs ?? ($utilisateurs?->total() ?? $utilisateurs?->count()); // en cas de pagination avec ->total()
                                @endphp
                                ...
                                <div class="d-flex align-items-center gap-2 text-info fw-semibold">
                                    ...
                                    <span>
                                        ...
                                        sur
                                        <span class="text-dark">{{ $total }}</span> utilisateurs
                                    </span>
                                </div>
