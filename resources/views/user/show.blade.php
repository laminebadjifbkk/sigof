                ...
                <div class="card border-info mb-3">
                    <div class="card-body pt-3">
                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered">
                            ...
                            @if ($user->operateurs->isNotEmpty())
                                @can('user-view')
                                    <li class="nav-item">
                                        <button class="nav-link" data-bs-toggle="tab"
                                            data-bs-target="#operateurs">Agréments</button>
                                    </li>
                                @endcan
                            @endif
                        ...
                        <div class="tab-content pt-0">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade profile-edit" id="operateurs">
                                    <h5 class="card-title text-center">OPERATEUR</h5>
                                    <div class="row mb-3">
                                        ...
                                        @else
                                            <div class="alert alert-info">
                                                <p class="text-muted">Aucun agrément pour l'instant !</p>
                                            </div>
                                        @endif
                                    </div>
                                </div>
