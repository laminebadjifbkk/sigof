                                    ...
                                    <div class="card-body d-flex align-items-center justify-content-between">
                                        <div>
                                            <h5 class="card-title text-info d-flex align-items-center">
                                                ...
                                                <i class="bi bi-envelope me-1"></i> Courriers <span class="fw-bold"></span>
                                            </h5>
                            ...
                            <a href="{{ route('nouvellesformations') }}">
                                <div class="card shadow-lg border-0 rounded-lg">
                                    <div class="card-body d-flex align-items-center justify-content-between">
                                        <div>
                                            <h5 class="card-title text-info d-flex align-items-center">
                                                <i class="bi bi-graduation-cap me-0"></i> Formation <span
                                                    class="fw-bold">&nbsp;|
                                                    Nouvelle</span>
                                            </h5>
                    ...
                    <div class="row">
                        @foreach ($projets as $projet)
                            @php
                                ...
                                $jours_restant = \Carbon\Carbon::now()->diffInDays(
                                    \Carbon\Carbon::parse($projet?->date_fermeture)->setTime(17, 0, 0),
                                    false,
                                );
