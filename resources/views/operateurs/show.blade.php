                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="tab-content pt-2">
                                    <div class="tab-pane fade" id="references-overview">
                                ...
                                <div class="tab-content pt-2">
                                    <div class="tab-pane fade" id="equipement-overview">
                                        <form method="post" action="#" enctype="multipart/form-data" class="row g-3">
                                            @csrf
                                            @method('PUT')
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="tab-content pt-2">
                                    <div class="tab-pane fade" id="formateur-overview">
                                        <form method="post" action="#" enctype="multipart/form-data" class="row g-3">
                                            @csrf
                                            @method('PUT')
                                            {{-- <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="card border-info shadow-sm mb-4">
                                                        <div class="card-body">
                                                            ...
                                                            <ul class="list-unstyled ps-3 mb-3">
                                                                <li><i class="bi bi-check-circle text-success me-2"></i>Quitus
                                                                    fiscal <span class="text-danger">*</span></li>
                                                                <li><i class="bi bi-check-circle text-success me-2"></i>Ninéa ou
                                                                    registre de
                                                                    commerce <span class="text-danger">*</span></li>
                                                                <li><i class="bi bi-check-circle text-success me-2"></i>Attestation
                                                                    de non
                                                                    fonctionnaire ou carte de retraite <span
                                                                        class="text-danger">*</span></li>
                                                                <li><i class="bi bi-check-circle text-success me-2"></i>Convention
                                                                    de
                                                                    partenariat
                                                                    ou contrat de location à usage professionnel <span
                                                                        class="text-danger">*</span>
                                                                </li>
                                                                <li><i class="bi bi-check-circle text-muted me-2"></i>Acte de
                                                                    création, arrêté
                                                                    de
                                                                    création ou récépissé de déclaration <small
                                                                        class="text-muted">(si
                                                                        disponible)</small></li>
                                                            </ul>
                                                            ...
                                                            <ul class="list-unstyled ps-3 mb-0">
                                                                <li><i class="bi bi-check-circle text-success me-2"></i>Acte de
                                                                    création ou
                                                                    arrêté de
                                                                    création<span class="text-danger">*</span></li>
                                                                <li><i class="bi bi-check-circle text-muted me-2"></i>Ninéa ou
                                                                    registre de
                                                ...
                                                <div class="col-12 col-lg-6">
                                                    <div class="card border-primary shadow-sm mb-4">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row mb-3 mt-3">
                                                                <label for="file" class="col-12 col-form-label">CHOISIR
                                                                    FICHIER<span class="text-danger mx-1">*</span></label>
                                                                <div class="col-12 col-lg-12 col-sm-12 col-xs-12">
                                                                    <div class="pt-2">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade pt-2" id="observations-overview">
                                ...
                                <div class="tab-content pt-2">
                                    <div class="tab-pane fade" id="localites-overview">
                                        <form method="post" action="#" enctype="multipart/form-data" class="row g-3">
                                            @csrf
                                            @method('PUT')
                                            {{-- <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="tab-content pt-2">
                                    <div class="tab-pane show active fade" id="module-overview">
                                ...
                                <div class="tab-pane fade pt-2" id="details-overview">
                                    <form method="post" action="#" enctype="multipart/form-data" class="row g-3">
                                        <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade pt-0" id="formation-overview">
