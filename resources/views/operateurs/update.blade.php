                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ route('operateurs.update', $operateur) }}"
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-md-12 col-lg-6 col-sm-12 col-xs-12 col-xxl-6">
                                            <label for="categorie" class="form-label">Type établissment<span
                                        ...
                                        <div class="col-12">
                                            <label for="operateur" class="form-label">Dénomination opérateur<span
                                                    class="text-danger mx-1">*</span></label>
                                        ...
                                        <div class="col-12 col-md-12 col-lg-6 col-sm-12 col-xs-12 col-xxl-6">
                                            <label for="operateurcategorie" class="form-label">Catégorie</label>
                                            <select name="operateurcategorie"
                                                ...
                                                data-placeholder="Choisir">
                                                <option
                                                    value="{{ old('operateurcategorie', $operateur->operateurcategorie?->name) }}">
