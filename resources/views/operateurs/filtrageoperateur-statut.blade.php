...
@section('title', 'ONFP | OPERATEURS - ' . $statut)
@section('space-work')
                        ...
                        @if (auth()->user()->hasRole('super-admin|admin|DEC'))
                            <div class="col-12 pt-5">
                                <div class="row">
                                    ...
                                    <!-- Sales Card -->
                                    @foreach ($groupes as $categorie => $items)
                                        <div class="col-12 col-md-4 col-lg-2 col-sm-12 col-xs-12 col-xxl-2">
                                            <div class="card info-card sales-card shadow-sm" style="max-width: 220px;">
                                                <div class="card-body p-2">
                                                    <h5 class="card-title text-truncate mb-1" title="{{ $categorie }}"
                                                        style="font-size: 1rem;">
                                                        {{ 'Catégorie | ' . $categorie }}
                                                    </h5>
                                                    <div class="d-flex align-items-center mb-2">
                                                    ...
                                                    <a href="{{ route('operateurs.parStatutCategorie', ['statut' => $statut, 'categorie' => $categorie]) }}"
                                                        target="_blank"
                                                        class="btn btn-outline-primary btn-sm w-100 d-flex align-items-center justify-content-center py-1"
                                                        style="font-size: 0.85rem; gap: 6px;">
                                                        Voir plus <i class="bi bi-arrow-right-short"></i>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($operateurs as $operateur)
                                            <tr>
                                                ...
                                                <td width="20%">{{ $operateur?->user?->operateur }}</td>
                                                            ...
                                                            <div class="filter">
                                                                ...
                                                                <ul
                                                                    ...
                                                                    @can('operateur-delete')
                                                                        <li>
                                                                            <form
                                                                                action="{{ route('certificationOperateur', $operateur->uuid) }}"
                                                                                method="post">
                                                                                @csrf
                                                                                <button type="submit"
                                                                                    class="dropdown-item show_confirm"
                                                                                    title="Supprimer"><i
                                                                                        class="bi bi-trash"></i>Certifier</button>
                                                                            </form>
                                                                        </li>
                                                                    @endcan
                                                                </ul>
                                                                    ...
                                                                    @can('operateur-certifier')
                                                                        <li>
                                                                            <form
                                                                                ...
                                                                                @csrf
                                                                                <button type="submit"
                                                                                    class="dropdown-item show_confirm_certifier">
