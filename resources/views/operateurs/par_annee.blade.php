                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                {{-- <div class="d-flex align-items-center gap-3">
                                    ...
                                    <span class="text-muted small">Liste des opérateurs</span>
                                </div> --}}

                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h1 class="mb-0">ANNEE : {{ $annee }} : {{ $total }}</h1>
                                    ...
                                    <tbody id="missions-container">
                                        @foreach ($groupes as $index => $items)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('operateurs.parStatutAgrement', ['statut' => $items->statut_agrement]) }}"
