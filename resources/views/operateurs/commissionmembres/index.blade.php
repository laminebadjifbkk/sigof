                                    ...
                                    <tbody>
                                        @foreach ($membres as $membre)
                                            <tr>
                                                ...
                                                <td>{{ $membre?->prenom }}</td> --}}
                                                <td>{{ $membre?->civilite . ' ' . $membre?->prenom . ' ' . $membre?->nom }}</td>
                            ...
                            <div class="modal-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="statut" value="{{ old('statut') }}"
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input name="telephone" type="text" maxlength="12"
                                                ...
                                                value="{{ old('telephone', $membre->telephone ?? '') }}" autocomplete="tel"
                                                placeholder="Téléphone">
                                            @error('telephone')
                                                <span class="invalid-feedback" role="alert">
                                                    <div>{{ $message }}</div>
                                        ...
                                        <div class="col-6">
                                            <label for="statut" class="form-label">Statut</label>
                                            <input type="text" name="statut" value="{{ old('statut', $membre->statut ?? '') }}"
                                                class="form-control form-control-sm @error('statut') is-invalid @enderror"
                                                id="statut" placeholder="Statut">
                                            @error('statut')
                                                <span class="invalid-feedback" role="alert">
