                                                        ...
                                                        @can('collective-show')
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                @can('collective-update')
                                                                    <li>
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('collectives.edit', $collectivemodule->collective) }}">
                                                                ...
                                                                @can('collective-delete')
                                                                    <li>
                                                                        <form method="POST"
                                                                            action="{{ route('collectives.destroy', $collectivemodule->collective) }}">
                                                                            @csrf
                                                                            @method('DELETE')
                                            ...
                                            @enderror
                                                    ...
                                                    <div class="col-12 col-md-12 col-lg-6">
                                                        ...
                                                        <select name="statut"
                                                            ...
                                                            @php $statuts = ['GIE', 'Association', 'Entreprise', 'Institution publique', 'Institution privée', 'Coopérative', 'COLLECTIVITE TERRITORIALE','PROFESSION LIBERALE', 'Autre']; @endphp
