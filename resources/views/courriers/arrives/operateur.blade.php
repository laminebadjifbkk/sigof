                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <span class="text-muted small">Liste des courriers opérateurs</span>
                            </div>
                            ...
                            <div class="d-flex align-items-center gap-2 text-info fw-semibold">
                                ...
                                <span>
                                    ...
                                    sur
                                    <span class="text-dark">{{ $total }}</span> courriers opérateurs
                                </span>
                            </div>
                        ...
                        @if ($arrives?->count() > 0)
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($arrives as $arrive)
                                            <tr>
                                                ...
                                                <td style="text-align: center;">{{ $arrive?->courrier?->numero_courrier }}
                                                </td>
                                                <td style="text-align: center;">
                            ...
                            @else
                                <div class="alert alert-info mt-3">Aucun courrier agrément enregistré pour le moment !!!
                                </div>
                        @endif
