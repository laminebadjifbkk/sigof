                ...
                <td colspan="2">
                    <table>
                        <tr>
                            ...
                            <h5 valign="top" style="text-align: center; margin-left: -75px;">
                            ...
                            <td colspan="3" align="right" valign="top">
                                <h3>
                                    ...
                                    <b> {{ __("Date d'arrivée : ") }} </b>
                                    {{ $courrier->date_recep?->format('d/m/Y') }} <br />
                                    <b> {{ __('N° du courrier : ') }} </b> <span style="color:rgb(255, 0, 0)"><b>
                                            <strong>{{ 'CA-' . $arrive->numero_arrive }}</strong>
                                        </b></span>
                                    <br />
                                    <h2><br><u>{{ __("FICHE D'IMPUTATION") }}</u></h2>
                ...
                <tr>
                    <td colspan="2" align="left" valign="top">
                        @if (isset($courrier->observation))
                            ...
                            <span style="color: red;">{{ $courrier->observation }}</span>
                        @else
                            <h4><u>Observations</u>:
                        @endif
                        </h4>
